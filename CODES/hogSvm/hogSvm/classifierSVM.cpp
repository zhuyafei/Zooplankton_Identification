...
void classifierSVM(Mat& trainData, Mat& labelsTrain, vector<string> trainImgName, vector<string> testImgName, string kernelFunction, Mat& resultTrain, Mat& resultTest)
{
    ...
    string predictTrainFeatureVector="./result/PredictTrain-Features-HOG.txt";
    string predictTestFeatureVector="./result/PredictTest-Features-HOG.txt";
    stringstream predictTrainDataTxt;
    stringstream predictTestDataTxt;//="./result/PredictTest-Result.txt";
...
//    Mat resultTrain;   // 输出分类结果
    ...
    predictTrainDataTxt<<"./result/PredictTrain-HOG-SVM-"<<kernelFunction<<".txt";
...
//    Mat resultTest;   // 输出分类结果
    ...
    predictTestDataTxt<<"./result/PredictTest-HOG-SVM-"<<kernelFunction<<".txt";
