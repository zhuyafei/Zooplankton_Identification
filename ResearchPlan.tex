...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.35\linewidth]{HOG-compare}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.35\linewidth]{LBP-compare}
...
\begin{enumerate}
    ...
    \begin{figure}[!ht]
        ...
        \label{fig:Pteropoda}
    \end{figure}
    \item 在取最大连通区域过程中，物体面积可能会比噪声小，导致目标物体被去除。（在Fiber类中出现错较多，如图~\ref{fig:Fiber}）
    \begin{figure}[!ht]
        \centering
        \subfigure[去噪后的图像]{
