function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy, predictLabel, iniLabel, TY, Y] = elm(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
...
%%%%%%%%%% Calculate training & testing classification accuracy
    ...
    for i = 1 : size(TV.T, 2)
        ...
        iniLabel(i,1) = label_index_expected;
        predictLabel(i,1) = label_index_actual;
        if label_index_actual~=label_index_expected
